...
$query_top = "SELECT 
                ...
                SUM(dv.cantidad * p.precio) AS total_ingreso
...
<div class="dashboard-card summary-box">
    <div class="card-header-clean-split">
        ...
        <a href="../articulos/index.php" class="btn-view-all">Ver todos</a>
    </div>
    ...
    <div class="products-list-container">
        ...
        ?>
            <div class="product-item-row">
                ...
                <div class="product-price-value">
                    S/ <?php echo number_format($prod['total_ingreso'], 2); ?>
                </div>
            </div>
        <?php 
            $posicion++;
        ...
        ?>
            <div class="product-item-row">
                ...
                <div class="product-price-value">S/ <?php echo number_format($prod['total'], 2); ?></div>
            </div>
        <?php 
            endforeach;
        endif; 
